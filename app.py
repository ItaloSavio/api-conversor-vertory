...
# ==========================================
# Configuração CloudConvert (Substitui o pdf2docx)
# ==========================================
...
# ==========================================
# ROTA 2: PDF para WORD (.docx) - Atualizado CloudConvert
# ==========================================
...
def convert_pdf_to_word():
    ...
    try:
        ...
        # Aguarda a conversão no servidor deles
        job = cloudconvert.Job.wait(id=job['id'])

        # Pega a URL de download gerada
        export_task = next(task for task in job['tasks'] if task['name'] == 'export-file')
        download_url = export_task['result']['files'][0]['url']

        # Limpa o arquivo temporário da sua máquina
        os.remove(temp_path)

        # Retorna o JSON que o frontend do Lovable agora está esperando
